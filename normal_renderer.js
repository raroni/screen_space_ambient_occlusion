function NormalRenderer(glContext, resolution, shaderProgram, boxRenderings) {
...
NormalRenderer.prototype.initialize = function() {
...
NormalRenderer.prototype.draw = function() {
  var gl = this.glContext;
  ...
  var modelNormalAttributeHandle = program.getAttributeHandle('ModelNormal');
  gl.enableVertexAttribArray(modelNormalAttributeHandle);
  ...
  this.boxRenderings.forEach(function(rendering) {
    ...
    gl.vertexAttribPointer(modelNormalAttributeHandle, 3, gl.FLOAT, false, 24, 12);
